...
//set asds to latlng(-0.15820148684206747, -69.992415571893758).
...
IF ADDONS:TR:IMPACTPOS:LNG < ASDS:LNG {
	...
	WAIT UNTIL VANG(HEADING(90, 40):VECTOR, SHIP:FACING:VECTOR) < 2.
	LOCK THROTTLE TO 0.7.
...
UNTIL SHIP:ALTITUDE < 8000 {
	LOCK ANGLE TO circle_distance(ADDONS:TR:IMPACTPOS, ASDS, SHIP:BODY:RADIUS) / 4.
...
LOCK TRUERADAR TO ALT:RADAR - 34.
